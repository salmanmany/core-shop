          ...
          <div className="container mx-auto px-4">
            ...
            <div className={`text-center mb-12 ${language === 'ar' ? 'text-right md:text-center' : ''}`}>
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                {t('mods.title')} <span className="text-primary">{t('mods.titleAccent')}</span>
              </h2>
            ...
            {loading ? (
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {mods.map(mod => (
                  <div key={mod.id} className="glass-card p-6 flex flex-col">
                    {/* Mod Image */}
                    {mod.image_url ? (
                      <img
                        src={mod.image_url}
                    ...
                    <button
                      ...
                      className="w-full py-3 rounded-xl font-semibold text-white bg-primary transition-all duration-300 hover:scale-105 hover:shadow-lg flex items-center justify-center gap-2"
                    >
